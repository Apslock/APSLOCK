...
export default function GrowthGoToMarketPage() {
  ...
  const [headline, setHeadline] = useState("Pipeline that holds, quarter after quarter.");
  ...
  const [eyebrow, setEyebrow] = useState("Growth & Go-To-Market");
  ...
  const [blobColor, setBlobColor] = useState("amber"); // sage, amber, slate, blush, custom
  const [customBlobColor, setCustomBlobColor] = useState("#b85c38");
            ...
            <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-[680px] px-4 md:px-0">
              ...
              <div className="transform-none md:-translate-y-12">
                <ExpertiseHeroCard scrollY={smoothY}
                  ...
                  body="Two-day alignment sessions."
                  icon="layers"
              ...
              <div className="transform-none">
                <ExpertiseHeroCard scrollY={smoothY}
                  ...
                  body="Lifecycle programs designed for revenue."
                  icon="target"
              ...
              <div className="transform-none md:-translate-y-18">
                <ExpertiseHeroCard scrollY={smoothY}
                  ...
                  title="Reporting"
                  body="Marketing measurement your CFO trusts."
                  icon="pen"
              ...
              <div className="transform-none md:translate-y-4">
                <ExpertiseHeroCard scrollY={smoothY}
                  ...
                  eyebrow="DEMAND GEN"
                  title="Paid Media"
                  body="Engineered for efficient pipeline."
                  icon="chat"
                  className="h-[260px] md:h-[316px] w-full"
                  rotate={1.7}
                />
